...
def ParseArgs():
    ...
    parser.add_argument("outpath", help="The cut path")#c:/path/
    parser.add_argument("listpath", help="The cut list")#C:/cut_list.txt:
...
#what is difference between patchsize and imagepatchsize?
