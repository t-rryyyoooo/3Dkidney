...
rebuild.py C:\Users\VMLAB\Desktop\kidney\margeTraining.txt -t C:\Users\VMLAB\Desktop\kidney\margeValidation.txt
...
for %%i in (%numArr%) do (
    ...
    segmentation3DUnet.py !ctpath! 3DUnetModel.yml C:\Users\VMLAB\Desktop\kidney\log\model\best_model_second.hdf5 C:\Users\VMLAB\Desktop\kidney\segmentedData\final_case00%%i.mha --mask !mask_path!
